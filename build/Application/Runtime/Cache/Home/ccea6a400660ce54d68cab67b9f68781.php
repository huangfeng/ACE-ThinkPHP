<?php if (!defined('THINK_PATH')) exit();?> <!DOCTYPE html>
 ...
 <head>
 	...
 	<!-- ace styles -->
 	<link rel="stylesheet" href="/admin/build/Public/css/ace.min.css" />

	<!--[if lte IE 9]>
	<link rel="stylesheet" href="/admin/build/Public/css/ace-part2.min.css" />
	<![endif]-->
	<link rel="stylesheet" href="/admin/build/Public/css/ace-rtl.min.css" />
										...
										<form>
											<fieldset>
												...
												<label class="block pull-left">
													<span class="block input-icon input-icon-right">
														<input type="password" class="form-control input-medium" placeholder="验证码" />
													</span>
												</label>

												<label class="block pull-right">
													<img src="<?php echo U('Index/verify');?>" width="120" height="34">
												</label>
												...
												<div class="clearfix">
													...
													<button type="button" onclick="window.location.href='<?php echo U('Index/index');?>';" class="width-35 pull-right btn btn-sm btn-primary">
