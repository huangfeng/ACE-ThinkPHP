...
<script src="/admin/build/Public/js/jquery.gritter.min.js"></script>
<script src="/admin/build/Public/js/spin.min.js"></script>
...
$('#myTab a[data-toggle="tab"]').on('shown.bs.tab', function (e) {
	...
	$('#gritter-regular').on(ace.click_event, function(){
		$.gritter.add({
			...
			image: '/admin/build/Public/avatars/avatar1.png', //in Ace demo dist will be replaced by correct /admin/build/Public path
			sticky: false,
			time: '',
	...
	$('#gritter-sticky').on(ace.click_event, function(){
		var unique_id = $.gritter.add({
			...
			image: '/admin/build/Public/avatars/avatar.png',
			sticky: true,
			time: '',
	...
	$('#gritter-max3').on(ace.click_event, function(){
		$.gritter.add({
			...
			image: '/admin/build/Public/avatars/avatar3.png', //in Ace demo dist will be replaced by correct /admin/build/Public path
			sticky: false,
