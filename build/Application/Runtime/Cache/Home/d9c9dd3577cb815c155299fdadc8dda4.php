...
<head>
	...
	<![endif]--> 
<link rel="stylesheet" href="/admin/build/Public/css/jquery-ui.custom.min.css" />
<link rel="stylesheet" href="/admin/build/Public/css/chosen.min.css" />
<link rel="stylesheet" href="/admin/build/Public/css/datepicker.min.css" />
<link rel="stylesheet" href="/admin/build/Public/css/bootstrap-timepicker.min.css" />
<link rel="stylesheet" href="/admin/build/Public/css/daterangepicker.min.css" />
<link rel="stylesheet" href="/admin/build/Public/css/bootstrap-datetimepicker.min.css" />
<link rel="stylesheet" href="/admin/build/Public/css/colorpicker.min.css" />
<style>
...
<script src="/admin/build/Public/js/chosen.jquery.min.js"></script>
<script src="/admin/build/Public/js/fuelux.spinner.min.js"></script>
<script src="/admin/build/Public/js/bootstrap-datepicker.min.js"></script>
<script src="/admin/build/Public/js/bootstrap-timepicker.min.js"></script>
<script src="/admin/build/Public/js/moment.min.js"></script>
<script src="/admin/build/Public/js/daterangepicker.min.js"></script>
<script src="/admin/build/Public/js/bootstrap-datetimepicker.min.js"></script>
<script src="/admin/build/Public/js/bootstrap-colorpicker.min.js"></script>
<script src="/admin/build/Public/js/jquery.knob.min.js"></script>
<script src="/admin/build/Public/js/jquery.autosize.min.js"></script>
<script src="/admin/build/Public/js/jquery.inputlimiter.1.3.1.min.js"></script>
<script src="/admin/build/Public/js/jquery.maskedinput.min.js"></script>
<script src="/admin/build/Public/js/bootstrap-tag.min.js"></script>
<script type="text/javascript">
	jQuery(function($) {
